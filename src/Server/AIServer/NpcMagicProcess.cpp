...
{
	int index = 0, send_index = 0, magicid = 0, sid = -1, tid = -1, data1 = 0, data2 = 0, data3 = 0,
	...
	if (command == MAGIC_FAIL)
	{
		...
		SetString(send_buff, pBuf, len - 1,
			send_index); // len ==> include WIZ_MAGIC_PROCESS command byte.
