...
enum e_DBResourceID
{
	...
	IDP_ELMORAD_VICTORY =
		107, // El Morad is victorious. They killed %d warriors and lost %d warriors
	...
	IDP_KNIGHT_INSUFFICIENT_LEVEL =
		112, // You need to be at least at Level 20 in order to create a Knights
	IDP_KNIGHT_INSUFFICIENT_LOYALTY =
		113, // You need to have at least 800 National Points in order to create a Knights
	...
	IDP_KNIGHT_INSUFFICIENT_GOLD =
		116, // You need to have at least 1,000,000 Coins in order to create a Knights
	...
	IDP_KNIGHT_MINIMUM_SUBLEADER =
		120, // This is authorized for ranks higher than Vice Head of Knights only.
	...
	IDS_ELMORAD_LOSER =
		130, // El Morad have lost the war. They killed [%d] warriors and lost [%d] warriors
	IDS_KARUS_LOSER =
		131, // Karus have lost the war. They killed [%d] warriors and lost [%d] warriors
	IDS_BANISH_USER =
	...
	IDS_KILL_GATEKEEPER =
		134, // The user that killed the enemy’s gatekeeper is [%s][%s]. Congratulations!!
	IDS_KILL_CAPTAIN =
		135, // The user that killed the enemy’s captain is [%s][%s]. Congratulations!!
	...
	IDS_BATTLEZONE_STATUS =
		159, // Number of killed Karus users : %d, Number of killed El Morad users : %d
	IDS_BANISH_LOSER =
	...
	IDS_CHALLENGER_REQUEST_END_NOTICE =
		175, // The registration period for Castle Siege War has now ended.
	...
	IDS_ASSAULT_EVENT_START =
		195, // We're under attack by monsters. Please save the World from the monsters!!
	...
	IDS_MONSTER_CHALLENGE_ANNOUNCEMENT =
		198, // The Forgotten Temple Event will start at %d for levels %d~%d
	...
	IDS_KING_KARUS_FUGITIVE_EVENT_MESSAGE_1 =
		211,                                  // The Karus King has awarded %s %d coins as a reward.
	IDS_KING_FUGITIVE_EVENT_MESSAGE_2 = 212,  // %s killed %s and received %d coins as a reward.
	IDS_KING_ELMO_PRIZE_EVENT_MESSAGE =
		213, // The ElMorad King has awarded %s %d coins as a reward.
	IDS_KING_ELMO_FUGITIVE_EVENT_MESSAGE_1 =
		214, // The El Morad King has awarded %s %d coins as a reward.
	...
	IDS_KING_RECOMMEND_REQUEST_MESSAGE =
		225, // User %s can nominate a King. Please nominate a King.
	...
	IDS_KING_ELECTION_RESULT_MESSAGE =
		229, // %d(percent) of the vote was won by %s to become a King.
	...
	IDS_KING_IMPEACHMENT_ELECTION_YES_RESULT_MESSAGE =
		236,                                     // Inpeachment Election has been accepted
	...
	IDS_BEEF_ROAST_VICTORY_KARUS =
		239, // The Karus warriors have destroyed the monument and can now enter Bifrost!
