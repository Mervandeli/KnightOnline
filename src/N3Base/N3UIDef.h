...
const uint32_t UIMSG_EDIT_TAB =
	0x00002000; // Edit에서 Tab이 들어옴 - NOTE: Officially this isn't triggered anymore
...
const uint32_t
	UI_MOUSEPROC_PREVINREGION           = 0x00000008; // 영역 안에 이전 틱의 마우스 포인터가 있었다.
